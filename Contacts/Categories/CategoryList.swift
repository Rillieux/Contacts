    ...
    struct CategoryList: View {
        ...
        private var newCategorySheet: some View {
            ///When we add a new category, we want it to initially show up last in the list.
            ///To achieve this, we get the count of the categories and
            ///send that Int to the NewCategoryheet.
